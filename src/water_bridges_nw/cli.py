...
def main():
    ...
    cluster_parser.add_argument("--threshold", type=float, default=6.0,
        help="9D Feature Vector distance threshold (Å) for average-link clustering. "
             ...
             "Note: This clustering compares the start, midpoint, and end coordinates "
             "of each path. Because it calculates Euclidean distance across 9 dimensions "
             "(3 spatial points), the numerical values will be larger than traditional "
             "Hausdorff or single-centroid distances. You may need to calibrate this "
             "value (e.g., 5.0–9.0 Å) depending on your system's flexibility.")
